...
class TableCalendar<T> extends StatefulWidget {
  ...
  final CalendarStyle eventStyle;
  ...
  final Map<DateTime, CalendarStyle>? Function(DateTime day)? styleForEvents;
  ...
  final CalendarStyle Function(DateTime day)? eventPredicate;
  ...
  TableCalendar({
    ...
    this.eventStyle = const CalendarStyle(),
    this.eventPredicate,
...
class _TableCalendarState<T> extends State<TableCalendar<T>> {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        Widget content = CellContent(
          ...
          locale: widget.locale,
          eventStyle: widget.calendarStyle,
        );
        ...
        if (!isDisabled) {
          ...
          final style = widget.styleForEvents?.call(day);

          Widget? markerWidget =
              widget.calendarBuilders.markerBuilder?.call(context, day, events);
          if (style != null && widget.isEventday) {
            CalendarStyle s = style[day]!;
              ...
              markerWidget = PositionedDirectional(
                ...
                child: Row(
                  ...
                  children: events
                      ...
                      .map((event) =>
                          _buildSingleMarker(day, event, markerSize, s))
                      .toList(),
                ),
              );
            }
                ...
                child: Row(
                  ...
                  children: events
                      ...
                      .map((event) => _buildSingleMarker(
                          day, event, markerSize, widget.calendarStyle))
                      .toList(),
                ),
              );
            }
  ...
  Widget _buildSingleMarker(
      DateTime day, T event, double markerSize, CalendarStyle? style) {
    return widget.calendarBuilders.singleMarkerBuilder
        ...
        Container(
          ...
          decoration: widget.isEventday
              ? style?.markerDecoration
