...
import '../../datasource/data/model/entity/manager_mail_model.dart';
import '../../datasource/repository/day_off_repository.dart';
import '../base_state/base_state.dart';

part 'edit_day_off_event.dart';
part 'edit_day_off_state.dart';

class EditDayOffBloc extends Bloc<EditDayOffEvent, EditDayOffState> {
  EditDayOffBloc(this.dayOffRepository) : super(EditDayOffInitial()) {
    on<EditDayOffEvent>((event, emit) {
