      ...
      body: HttpStreamHandler<UserBloc,BaseState>(
        ...
        builder: (context,state){
          return Container(
            ...
            child: Padding(
                padding: EdgeInsets.symmetric(horizontal: width_12, vertical: height_50),
                  ...
                  child: Column(
                    children:[
                      Row(
                        ...
                        children: [
                          Text(TextConstants.textUserInfo,style: TextStyleCommon.textStyleAppBar,),
                          GestureDetector(
                            onTap: (){
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(_bloc.edit?TextConstants.textEdit:TextConstants.textCancel,style: TextStyleCommon.textStyleAppBar,),
                              ],
                            ),
                          ),
                        ],
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Text(TextConstants.textButtonLogout,style: TextStyleCommon.textField),
                                          ],
                                        ),
                                      )
                                    ],
