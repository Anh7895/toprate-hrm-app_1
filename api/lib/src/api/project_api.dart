...
class ProjectApi {
  ...
  Future<Response<Project>> addProject({ 
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> getAllProject({ 
    String? limit = '10',
    String? page = '1',
  ...
  /// Returns a [Future] containing a [Response] with a [Project] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Project>> getByIdProject({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/projects/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Project] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Project>> patchUpdateProject({ 
    required int id,
    required Project project,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
