...
class SalaryApi {
  ...
  const SalaryApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Salary] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Salary>> addSalary({ 
    ...
    try {
      const _type = FullType(Salary);
      _bodyData = _serializers.serialize(salary, specifiedType: _type);
    ...
    Salary _responseData;

    try {
      const _responseType = FullType(Salary);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse2001>> downloadTemplateImportSalary({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/salaries/template';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> exportSalary({ 
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> getAllSalary({ 
    String? limit = '10',
    String? page = '1',
    String? orderBy = 'id ASC',
    String? fullNameTilde = 'string',
  ...
  /// Returns a [Future] containing a [Response] with a [Salary] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Salary>> getByIdSalary({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/salaries/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> importSalary({ 
    required InlineObject inlineObject,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [Salary] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Salary>> patchUpdateSalary({ 
    required int id,
    required Salary salary,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
