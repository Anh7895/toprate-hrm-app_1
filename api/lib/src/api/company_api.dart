...
class CompanyApi {
  ...
  Future<Response<Company>> addCompany({ 
    ...
    try {
      const _type = FullType(Company);
      _bodyData = _serializers.serialize(company, specifiedType: _type);
    ...
    try {
      const _responseType = FullType(Company);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Company>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Company>>> getAllCompanies({ 
    ...
    BuiltList<Company> _responseData;
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> getAllCompany({ 
    String? limit = '10',
    String? page = '1',
  ...
  /// Returns a [Future] containing a [Response] with a [Company] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Company>> getByIdCompany({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [Company] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Company>> patchUpdateCompany({ 
    required int id,
    required Company company,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
