...
part of 'o_timekeeping_detail_user_id.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$OTimekeepingDetailUserId extends OTimekeepingDetailUserId {
  @override
  final int? id;
  @override
  ...
  final String? code;
  @override
  final BuiltList<OTimekeepingDetail>? timekeepingDetail;
  @override
  final Salary? salary;

  factory _$OTimekeepingDetailUserId(
          [void Function(OTimekeepingDetailUserIdBuilder)? updates]) =>
      (new OTimekeepingDetailUserIdBuilder()..update(updates)).build();

  _$OTimekeepingDetailUserId._(
      {this.id,
      this.username,
      this.fullName,
      this.phone,
  ...
  @override
  OTimekeepingDetailUserId rebuild(
          void Function(OTimekeepingDetailUserIdBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  OTimekeepingDetailUserIdBuilder toBuilder() =>
      new OTimekeepingDetailUserIdBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is OTimekeepingDetailUserId &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('OTimekeepingDetailUserId')
          ..add('id', id)
...
class OTimekeepingDetailUserIdBuilder
    implements
        Builder<OTimekeepingDetailUserId, OTimekeepingDetailUserIdBuilder> {
  _$OTimekeepingDetailUserId? _$v;
  ...
  ListBuilder<OTimekeepingDetail>? _timekeepingDetail;
  ListBuilder<OTimekeepingDetail> get timekeepingDetail =>
      _$this._timekeepingDetail ??= new ListBuilder<OTimekeepingDetail>();
  set timekeepingDetail(ListBuilder<OTimekeepingDetail>? timekeepingDetail) =>
  ...
  OTimekeepingDetailUserIdBuilder() {
    OTimekeepingDetailUserId._defaults(this);
  }

  OTimekeepingDetailUserIdBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(OTimekeepingDetailUserId other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$OTimekeepingDetailUserId;
  }

  @override
  void update(void Function(OTimekeepingDetailUserIdBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$OTimekeepingDetailUserId build() {
    _$OTimekeepingDetailUserId _$result;
    try {
      _$result = _$v ??
          new _$OTimekeepingDetailUserId._(
              id: id,
              username: username,
              fullName: fullName,
              phone: phone,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'OTimekeepingDetailUserId', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
