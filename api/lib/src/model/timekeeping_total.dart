...
/// * [company] 
/// * [user] 
abstract class TimekeepingTotal implements Built<TimekeepingTotal, TimekeepingTotalBuilder> {
    ...
    static void _defaults(TimekeepingTotalBuilder b) => b;

    factory TimekeepingTotal([void updates(TimekeepingTotalBuilder b)]) = _$TimekeepingTotal;

    @BuiltValueSerializer(custom: true)
    static Serializer<TimekeepingTotal> get serializer => _$TimekeepingTotalSerializer();
}

class _$TimekeepingTotalSerializer implements StructuredSerializer<TimekeepingTotal> {
    @override
    final Iterable<Type> types = const [TimekeepingTotal, _$TimekeepingTotal];

    @override
    final String wireName = r'TimekeepingTotal';

    @override
    Iterable<Object?> serialize(Serializers serializers, TimekeepingTotal object,
    ...
    @override
    TimekeepingTotal deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TimekeepingTotalBuilder();
