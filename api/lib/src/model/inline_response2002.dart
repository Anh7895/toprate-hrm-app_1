...
///
/// Properties:
/// * [urlDownloadTemplateTimekeeping] - message
abstract class InlineResponse2002 implements Built<InlineResponse2002, InlineResponse2002Builder> {
    /// message
    @BuiltValueField(wireName: r'url_download_template_timekeeping')
...
class _$InlineResponse2002Serializer implements StructuredSerializer<InlineResponse2002> {
    ...
    Iterable<Object?> serialize(Serializers serializers, InlineResponse2002 object,
        ...
        final result = <Object?>[];
        if (object.urlDownloadTemplateTimekeeping != null) {
            result
                ..add(r'url_download_template_timekeeping')
                ..add(serializers.serialize(object.urlDownloadTemplateTimekeeping,
    ...
    InlineResponse2002 deserialize(Serializers serializers, Iterable<Object?> serialized,
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                case r'url_download_template_timekeeping':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(String)) as String;
                    result.urlDownloadTemplateTimekeeping = valueDes;
                    break;
            }
        }
        return result.build();
