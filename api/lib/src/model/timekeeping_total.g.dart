...
part of 'timekeeping_total.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$TimekeepingTotal extends TimekeepingTotal {
  @override
  final int? id;
  @override
  final int? companyId;
  ...
  factory _$TimekeepingTotal(
          [void Function(TimekeepingTotalBuilder)? updates]) =>
      (new TimekeepingTotalBuilder()..update(updates)).build();

  _$TimekeepingTotal._(
      {this.id,
      this.companyId,
      this.userId,
      this.date,
  ...
  @override
  TimekeepingTotal rebuild(void Function(TimekeepingTotalBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  TimekeepingTotalBuilder toBuilder() =>
      new TimekeepingTotalBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is TimekeepingTotal &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('TimekeepingTotal')
          ..add('id', id)
...
class TimekeepingTotalBuilder
    implements Builder<TimekeepingTotal, TimekeepingTotalBuilder> {
  _$TimekeepingTotal? _$v;
  ...
  TimekeepingTotalBuilder() {
    TimekeepingTotal._defaults(this);
  }

  TimekeepingTotalBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(TimekeepingTotal other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$TimekeepingTotal;
  }

  @override
  void update(void Function(TimekeepingTotalBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$TimekeepingTotal build() {
    _$TimekeepingTotal _$result;
    try {
      _$result = _$v ??
          new _$TimekeepingTotal._(
              id: id,
              companyId: companyId,
              userId: userId,
              date: date,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'TimekeepingTotal', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
