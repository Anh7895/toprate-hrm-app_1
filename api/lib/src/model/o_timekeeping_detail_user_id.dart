...
import 'package:openapi/src/model/o_timekeeping_detail.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'o_timekeeping_detail_user_id.g.dart';

/// OTimekeepingDetailUserId
///
/// Properties:
/// * [id] 
/// * [username] 
...
/// * [timekeepingDetail] 
/// * [salary] 
abstract class OTimekeepingDetailUserId implements Built<OTimekeepingDetailUserId, OTimekeepingDetailUserIdBuilder> {
    ...
    BuiltList<OTimekeepingDetail>? get timekeepingDetail;

    @BuiltValueField(wireName: r'salary')
    Salary? get salary;

    OTimekeepingDetailUserId._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(OTimekeepingDetailUserIdBuilder b) => b;

    factory OTimekeepingDetailUserId([void updates(OTimekeepingDetailUserIdBuilder b)]) = _$OTimekeepingDetailUserId;

    @BuiltValueSerializer(custom: true)
    static Serializer<OTimekeepingDetailUserId> get serializer => _$OTimekeepingDetailUserIdSerializer();
}

class _$OTimekeepingDetailUserIdSerializer implements StructuredSerializer<OTimekeepingDetailUserId> {
    @override
    final Iterable<Type> types = const [OTimekeepingDetailUserId, _$OTimekeepingDetailUserId];

    @override
    final String wireName = r'OTimekeepingDetailUserId';

    @override
    Iterable<Object?> serialize(Serializers serializers, OTimekeepingDetailUserId object,
        ...
        if (object.timekeepingDetail != null) {
            result
                ...
                ..add(serializers.serialize(object.timekeepingDetail,
                    specifiedType: const FullType(BuiltList, [FullType(OTimekeepingDetail)])));
        }
    ...
    @override
    OTimekeepingDetailUserId deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = OTimekeepingDetailUserIdBuilder();
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'timekeeping_detail':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(OTimekeepingDetail)])) as BuiltList<OTimekeepingDetail>;
