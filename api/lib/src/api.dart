...
class Openapi {
  ...
  /// Get SettingBlockApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  SettingBlockApi getSettingBlockApi() {
    return SettingBlockApi(dio, serializers);
  }
